...
brew cask install mojibar &>/dev/null
...
sudo pip install -U howdoi ptpython ipython virtualenvwrapper Pygments pythonpy unp simpletornadoserver thefuck joe polysh&>/dev/null
#pip for vim
